      ...
      <div className="max-w-7xl mx-auto grid md:grid-cols-2 gap-12 md:gap-16 items-center">
        <div className="flex justify-center">
          <div className="relative w-full max-w-lg aspect-square border-[4px] border-black rounded-full overflow-hidden bg-[#FF6B6B] shadow-[-8px_8px_0px_0px_rgba(0,0,0,1)]">
            <Image src="/wazingwa.jpg" alt="Wazingwa Mugala" fill className="object-cover" />
          </div>
        </div>
        ...
        <div className="space-y-6 md:space-y-8">
          ...
          <div className="space-y-6">
            <div className="flex gap-4 items-start">
              ...
              <div>
                <h3 className="text-lg md:text-xl font-bold mb-2">The Copperbelt University</h3>
                <p className="text-gray-600 text-sm md:text-base">
                  Bachelor's degree, Computer Engineering · (November 2023)
                </p>
              </div>
            </div>
            ...
            <div className="flex gap-4 items-start">
              ...
              <div>
                <h3 className="text-lg md:text-xl font-bold mb-2">Hillcrest National STEM School</h3>
                <p className="text-gray-600 text-sm md:text-base">
                  Secondary School Certificate · (January 2020 - November 2022)
                </p>
              </div>
            </div>
          </div>
